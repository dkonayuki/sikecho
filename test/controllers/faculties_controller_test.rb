...
class FacultiesControllerTest < ActionController::TestCase
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post :create, faculty: { name: @faculty.name, university_id: @faculty.university_id, website: @faculty.website }
    end
  ...
  test "should update faculty" do
    patch :update, id: @faculty, faculty: { name: @faculty.name, university_id: @faculty.university_id, website: @faculty.website }
    assert_redirected_to faculty_path(assigns(:faculty))
  end
